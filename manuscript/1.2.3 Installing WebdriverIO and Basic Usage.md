...
So, in a directory of your choice, make a new folder called `wdio-standalone` (We'll cover the 'standalone' name in a little bit):
...
![IMAGE](resources/AA4D4E0244560ACB403160A59B041A44.jpg =1010x280)
