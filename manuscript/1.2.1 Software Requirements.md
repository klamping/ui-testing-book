...
- A text-editor (I use [Sublime Text 3](https://www.sublimetext.com/3), but [Webstorm](https://www.jetbrains.com/webstorm) and [VSCode](https://code.visualstudio.com/) are other great options)
