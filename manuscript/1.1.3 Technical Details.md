...
- WebdriverIO: 8.33.1
- Java 8 (optional)
- MongoDB 4.2 (very optional)

### Node.js Requirements

[Check the Webdriver.io website for minimum Node.js version requirements](https://webdriver.io/docs/gettingstarted#system-requirements). Normally, WebdriverIO works with the latest few LTS versions of Node.js. 
...
* **[Discord](https://discord.webdriver.io/)** - WebdriverIO runs an official chat room for folks seeking help with the tool itself. 
